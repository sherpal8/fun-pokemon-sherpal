const { Character, grassCharacter, Trainer } = require("./pokemon");
...
class Battle {
  constructor(trainer1, trainer2) {
    ...
    console.log(
      `${this.trainer1.storage[0].name} has dealt a ${this.trainer1.storage[0].attackDamage} point damage to ${this.trainer2.storage[0].name}`
    );
